...
module.exports = {
  ...
  editCategoryById: async (req, res) => {
    try {
      ...
      if (category) {
        return apiResponse.DUPLICATE_VALUE({ res, message: MESSAGE.DATA_EXIST("This Category") });
      }
  ...
  editServiceById: async (req, res) => {
    try {
      ...
      if (service) {
        return apiResponse.DUPLICATE_VALUE({ res, message: MESSAGE.DATA_EXIST("This Service") });
      }
