...
router.use("/admin", authMiddleware({ usersAllowed: [ROLE.ADMIN] }), require("./admin/profile.route"));
...
router.use("/customer", authMiddleware({ usersAllowed: [ROLE.USER] }), require("./customer/vehicles.route"));
